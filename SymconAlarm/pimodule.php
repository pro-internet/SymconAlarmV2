...
abstract class PISymconModule extends IPSModule {
    ...
    protected function initDetails () {
        ...
        if ($this->Details) {
            ...
            $this->hide($events);
            $this->createRealOnChangeEvents(array($details . "|onDetailsChange"), $this->InstanceID);
    ...
    protected function addSetValue ($id) { 
        ...
        if (!$this->doesExist($this->searchObjectByName("SetValue"))) {
            ...
            $setValueScript = $this->checkScript("SetValue", "<?php SetValue(\$_IPS['SENDER'], \$_IPS['VALUE']); ?>", false);
                    ...
                    foreach ($folder['ChildrenIDs'] as $elem) {
                        ...
                        if (!$this->doesExist($this->searchObjectByName($obj['ObjectName'], $newFolder))) {
                            ...
                            if ($obj['ObjectType'] == $this->objectTypeByName("link")) {
                                ...
                                //     echo $ownName . " planned Ident: " . $this->nameToIdent($ownName . $obj['ObjectName']);
